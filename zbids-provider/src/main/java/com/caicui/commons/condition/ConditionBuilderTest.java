...
import com.caicui.commons.assertion.Assert;
...
public class ConditionBuilderTest {
    ...
    public static void main(String[] args) throws Exception {
        Object[] objects = new Object[]{
                true, "hello", Boolean.FALSE, "sss", true, "hello", Boolean.FALSE, "sss", true, "hello", Boolean.FALSE, "sss", true, "hello",
                Boolean.FALSE, "sss", true, "hello", Boolean.FALSE, "sss", true, "hello", Boolean.FALSE, "sss", true, "hello", Boolean.FALSE, "sss", true,
                "hello", Boolean.FALSE, "sss",
        };
